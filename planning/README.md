# CARDEX — Workspace de planificación institucional

Planificación completa bajo régimen institucional definido el 2026-04-14.

## Principios rectores
1. Presupuesto €0 / Single VPS — arquitectura 100% open-source
2. Sin techos mentales — discovery iterativo hasta exhaustividad verificable
3. 360° por defecto — multi-redundancia obligatoria

(Detalle en `01_MASTER_BRIEF/`.)
...
## Convenciones
Markdown CommonMark. Tablas para datos estructurados. Sin emojis. Tono formal, factual, sin adornos.
