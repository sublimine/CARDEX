"""automobile.de â€” Playwright. Site appears minimal; attempting DOM extraction."""
from __future__ import annotations
import asyncio, re
from scrapers.common.indexer import run_portal
from scrapers.common.pw_base import dom_paginate

_SOURCE, _COUNTRY, _DOMAIN = "automobile_de", "DE", "www.automobile.de"
_BASE = "https://www.automobile.de"
_HREF_RE = re.compile(r'href="(/auto-\d+\.html)"')
_JSON_RE = re.compile(r'"/auto-\d+\.html"')
...
async def _collect() -> list[str]:
    return await dom_paginate(
        ...
        search_url_fn=lambda p: f"https://www.automobile.de/?page={p}",
